            ...
            <div class="col-lg-4 text-center bg-primary border-inner py-3 align-items-center">
                <div class="d-inline-flex align-items-center justify-content-center">
                    <a href="index.html" class="navbar-brand">
                        <h1 class="m-0 text-uppercase text-white"><i class="fa fa-birthday-cake fs-1 text-dark me-3"></i>Admin  Schedule</h1>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid bg-dark bg-img p-5 mb-5">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="display-4 text-uppercase text-white">Add Schedule</h1>
                <a href="">Home</a>
        ...
        <form method="POST" action="" style="margin-top: 20px;">
            <div class="form-group">
                ...
                <select id="subject" name="subject" class="form-control">
                    ...
                    <option value="Social Studies">Testing</option>
                </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="time" name="time" placeholder="e.g. 8:00am - 9:00am" class="form-control">
            </div>
            <div class="form-group">
                <label for="class" style="font-size: 18px; font-weight: bold;">Class</label>
                <input type="text" id="class" name="class" placeholder="e.g. Grade 8A" class="form-control">
            </div>
		 ...
		 <?php 
		    ...
		    if(isset($_POST['submit'])){
               ...
               $result= mysqli_query($conn, "INSERT into records values('$subject','$day','$time','$class')");
               if($result){
                //echo "The Data was Added succefully";
